...
class EmbeddingMatcher:
    ...
    Scores an image embedding against a text embedding relative to a neutral
    ...
    to the neutral, >0.5 means it leans toward the description.
    ...
    def __init__(self, neutral_embedding: Embedding, temperature: float = 100.0) -> None:
        self._neutral = neutral_embedding
    ...
    def probability(self, image_embedding: Embedding, text_embedding: Embedding) -> float:
        ...
        score_null = image_embedding.cosine(self._neutral)
